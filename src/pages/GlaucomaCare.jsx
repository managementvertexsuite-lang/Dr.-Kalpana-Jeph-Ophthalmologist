    ...
    <div className="detail-page">
      ...
      <div className="detail-content">
        ...
        <section className="info-section">
          <h2>What Is Glaucoma Shunt Surgery?</h2>
          <p>
        ...
        <section className="info-section">
          <h2>Why Is Glaucoma Tube Shunt Surgery Needed?</h2>
          <p>
          ...
          <ul className="checklist">
            <li>Persistent high IOP despite maximum use of eye drops or laser therapy</li>
            <li>Advanced glaucoma with risk of optic nerve damage</li>
            <li>Complex cases, such as neovascular or congenital glaucoma</li>
            <li>Previous failed trabeculectomy or scarring that blocks normal drainage pathways</li>
          </ul>
          <p>
        ...
        <section className="info-section">
          <h2>Glaucoma Shunt Surgery Steps Explained</h2>
          <p>
          ...
          <h3>Here's how glaucoma tube shunt surgery is done:</h3>
          <ul className="checklist">
            <li>The eye is numbed using anaesthetic drops or injections.</li>
            <li>A small incision is made in the white part of the eye (sclera).</li>
            <li>The surgeon places a small tube implant inside the eye to allow fluid drainage.</li>
            <li>The other end of the tube connects to a reservoir plate, which is secured under the conjunctiva.</li>
            <li>The fluid drains from the eye into this plate, where it is naturally absorbed.</li>
          </ul>
          <p>
        ...
        <section className="info-section">
          <h2>What to Expect During Glaucoma Shunt Surgery</h2>

          <div className="subsection">
            <h3>Pre-Surgery Preparation</h3>
            <p>
        ...
        <section className="info-section">
          <h2>Recovery After Glaucoma Shunt Surgery</h2>

          <div className="subsection">
            <h3>Post-Surgery Instructions</h3>
            <p>
            ...
            <h4>Patients should:</h4>
            <ul className="checklist">
              <li>Avoid rubbing or pressing the operated eye</li>
              <li>Wear an eye shield at night for protection</li>
              <li>Avoid strenuous activities or swimming until cleared by the doctor</li>
              <li>Attend all follow-up appointments for monitoring</li>
            </ul>
            <p>
        ...
        <section className="info-section">
          <h2>Glaucoma Shunt Surgery Recovery Time</h2>
          <p>
            The glaucoma shunt surgery recovery time varies for each patient, but typically takes <strong>4-6 weeks</strong> for complete healing. Blurred vision and mild redness are common during the first few days.
          </p>
          <p>
        ...
        <section className="info-section">
          <h2>Complications of Glaucoma Shunt Surgery</h2>
          <p>
          ...
          <h3>Possible glaucoma shunt surgery complications include:</h3>
          <ul className="checklist">
            <li>Temporary redness, irritation, or discomfort</li>
            <li>Mild bleeding or infection</li>
            <li>Over-drainage, leading to low eye pressure</li>
            <li>Tube blockage or scarring at the drainage site</li>
            <li>Cataract formation over time</li>
          </ul>
          <p>
        ...
        <section className="info-section highlight">
          <h2>Benefits of Glaucoma Tube Shunt Surgery</h2>
          <p>
          ...
          <ul className="checklist">
            <li>Long-term control of intraocular pressure</li>
            <li>Reduced dependency on multiple glaucoma medications</li>
            <li>Protection of the optic nerve from further damage</li>
            <li>Improved quality of life through stable vision</li>
            <li>Effective management when other surgeries have failed</li>
          </ul>
          <p>
        ...
        <section className="info-section">
          <h2>How to Prepare for Glaucoma Shunt Surgery</h2>
          <p>
            Proper preparation for glaucoma shunt surgery ensures a smoother recovery and optimal outcomes.
          </p>
          <h3>Patients should:</h3>
          <ul className="checklist">
            <li>Share their full medical history and medications with the ophthalmologist</li>
            <li>Stop taking blood-thinning medicines if advised</li>
            <li>Arrange transportation after surgery, as driving immediately after is not recommended</li>
            <li>Follow any fasting instructions before the operation</li>
          </ul>
          <p>
        ...
        <section className="info-section">
          <h2>Conclusion: Is Glaucoma Shunt Surgery Right for You?</h2>
          <p>
            Glaucoma shunt surgery is a proven and safe treatment for patients whose eye pressure remains high despite other treatments. Although it does not restore lost vision, it helps prevent further optic nerve damage by effectively lowering intraocular pressure.
          </p>
          <p>
            For many patients, this surgery provides lasting relief, reduced reliance on medications, and a better quality of life. Consulting an ophthalmologist is the best way to determine whether glaucoma tube shunt surgery is the right option based on your condition and eye health.
          </p>
        </section>
